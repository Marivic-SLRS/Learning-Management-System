                    ...
                    <div class="container">
                      ...
                      <h3 style=" text-align: center;">Account Information</h3>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" employee_id="employee_id" value="<?php echo $row['employee_id']; ?>" readonly>
                        </div>
                        
                        <div class="mb-3">
                            <label for="fullname" class="form-label">Full Name</label>
                            <input type="text" class="form-control" fullname="fullname" value="<?php echo $row['fullname']; ?>" readonly>
                        </div>
                          <div class="mb-3">
                            <label for="gender" class="form-label">Gender</label>
                            <input type="text" class="form-control" gender="gender" value="<?php echo $row['gender']; ?>" readonly>
                        </div>
                        
                        <div class="mb-3">
                            <label for="address" class="form-label">Address</label>
                            <input type="text" class="form-control" address="address" value="<?php echo $row['address']; ?>" readonly>
                        </div>
                         <div class="mb-3">
                            <label for="contact_no" class="form-label">Contact Number</label>
                            <input type="text" class="form-control" contact_no="contact_no" value="<?php echo $row['contact_no']; ?>" readonly>
                        </div>

                        <div class="mb-3">
                            <label for="qualification" class="form-label">Qualification</label>
                            <input type="text" class="form-control" qualification="qualification" value="<?php echo $row['qualification']; ?>" readonly>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" password="password" value="<?php echo $row['password']; ?>" readonly>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" code="code" value="<?php echo $row['code']; ?>" readonly>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" qualification="emergency_num" value="<?php echo $row['emergency_num']; ?>" readonly>
                        </div>

                        <div class="mb-3">
                            <label for="emergency_person" class="form-label">Emergency Person</label>
                            <input type="text" class="form-control" emergency_person="emergency_person" value="<?php echo $row['emergency_person']; ?>" readonly>
                        </div>

                        <div class="d-grid gap-2">
                            <a href="http://localhost/Learning%20Management%20System/3teacher/edit.php" class="btn btn-primary">Edit</a>
                        </div>
                        <br><br><br>
                    </div> 
                </div>  
