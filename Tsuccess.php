...
<head>
    ...
    <link rel="stylesheet" href="styles.css"> <!-- If you have custom styles -->
...
<body>
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3 text-center" style="background-color:rgba(250,250,250,0.7);"> <br>
                ...
                <button onclick="goToHome()" class="btn btn-primary">Home</button> <br> <br>
            </div>
        </div>
    </div>
    ...
    <script>
        function goToHome() {
            window.location.href = "http://localhost/Learning%20Management%20System/index.php";
        }
    </script>
</body>
</html>
