...
<div class="content-wrapper" style="min-height: 567.854px;">
  <div>
    ...
    <div class="content-header" style="background-color:darkgray; margin: 0;border-radius: 10px;">
          ...
          <style>
          th {
      background-color:#033e3e; /* Blue background color */
...
<div class="container mt-5 table-container">
    <div class="table-responsive table-responsive-lg">
        ...
        <table class="table table-bordered container-fluid table-striped table-hover">
            <thead>
                <tr>
                    <th style="background-color: #033e3e; color: #ffffff;">File Name</th>
                    <th style="background-color: #033e3e; color: #ffffff;">File Size</th>
                    <th style="background-color: #033e3e; color: #ffffff;">File Type</th>
                    <th style="background-color: #033e3e; color: #ffffff;">Class Name</th>
                    <th style="background-color: #033e3e; color: #ffffff;">Action</th>
                </tr>
            </thead>
            <tbody>
            <?php
            ...
            // SQL query to select files from the database
            $sql = "SELECT * FROM files WHERE class_name = '$Classname'";
            $result = $conn->query($sql);

            // Check if any rows were returned
            if ($result->num_rows > 0) {
                // Loop through the fetched files and display them in table rows
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<td>';
                    // Provide a view button for all files
                 
    // Example PHP code snippet with gradient buttons
    echo '<a href="http://localhost/Learning%20Management%20System/3teacher/uploads/' . $row['filename'] . '" target="_blank" class="btn btn-gradient" style="margin-right: 10px;">View</a>';
    // Provide a download button for all files
    echo '<a href="http://localhost/Learning%20Management%20System/3teacher/uploads/' . $row['filename'] . '" class="btn btn-gradient" download>Download</a>';
