...
$sql = "SELECT picture FROM student WHERE full_name='$fullname'";
      ...
      if (!empty($_FILES["picture"]["name"])) {
          ...
          if (in_array($_FILES["picture"]["type"], $allowedTypes) && $_FILES["picture"]["size"] <= $maxFileSize) {
              if (move_uploaded_file($_FILES["picture"]["tmp_name"], $targetFile)) {
                  $fullname = $_SESSION["fullname"];
                  $sql = "UPDATE student SET picture =? WHERE full_name =?";
...
<div class="content-wrapper" style="min-height: 567.854px;">
        ...
        <?php
            if (!empty($picture)) {
                ...
                echo '<br><br><br><p style = "text-align:center;"><img src="http://localhost/Learning%20Management%20System/2student/profiles/'  . $picture . '" alt="Profile Picture" class="img-fluid" style="max-width: 150px; max-height: 150px;"></p>';
        ...
        <form method="POST" action="profilepics.php" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <a href="http://localhost/Learning%20Management%20System/2student/dashboard.php" class="btn btn-primary btn-block">Dashboard</a>
                </div>
            </div>
        </form>
        </div>
