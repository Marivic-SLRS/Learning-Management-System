...
if ($_SERVER["REQUEST_METHOD"] == "POST" ) {
    ...
    $contact_num = isset($_POST["contact_num"]) ? $_POST["contact_num"] : null;
    $classs = isset($_POST["classs"]) ? $_POST["classs"] : null;
    $contact_person = isset($_POST["contact_person"]) ? $_POST["contact_person"] : null;
    $contact_address = isset($_POST["contact_no"]) ? $_POST["contact_no"] : null;
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Prepare and execute SQL query to update the database

        if (strlen($contact_no) == 11 && strlen($contact_num) == 11){

          if ($cpassword == $password){
        
            $sql = "UPDATE student SET password = '$password', full_name = '$full_name', code = '$code', classs = '$classs', contact_person = '$contact_person', contact_num = '$contact_num', contact_address = '$contact_address' WHERE Student_id = $student_id";
        ...
        } else if ((strlen($contact_no) == 11 && strlen($contact_num) != 11) || (strlen($contact_no) != 11 && strlen($contact_num) == 11) || (strlen($contact_no) != 11 && strlen($contact_num) != 11)) {
        $_SESSION['error'] = 'Mobile Numbers should be 11 Digits.';
        }   
    }  
}
    ...
    <div>
         ...
         <div class="content-header" style="background-color:darkgray; margin: 0;border-radius: 10px;">
              <div class="container-fluid">
                <div class="row mb-2">
                  <div class="col-sm-6" >
                    <h4 class="m-0" style="font-family: georgia; font-size: 14px;">Edit account-></h4>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <form method="POST" action="edit.php">
                    <!-- Include a hidden field to carry the student_id -->
                    ...
                    <div class="container-fluid">
                        <div class="container">
                            <div class="row justify-content-center">
                                <br><br>
                                <h3 style="text-align: center;">Edit your Information</h3>
                                <br><br>
                                ...
                                <?php if (!empty($row)) { ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="classs" value="<?php echo $row['classs']; ?>" readonly>
                                    </div>
                                    <div class="mb-3">
                          ...
                          Code must be 6 digits.
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="contact_num" value="<?php echo $row['contact_num']; ?>" minlength="11" maxlength="11" pattern=".{11,11}"required>
                                         <div class="invalid-feedback">
                                           Mobile numbers should be 11 digits.
                                          </div>
                                    </div>
