               ...
               if (isset($_POST['change-password'])) {             
                    ...
                    $cpassword = $_POST['cpassword']; 
					 if ($password !== $cpassword) {
                        ...
                        $sql = "UPDATE facultys SET password = '$password' WHERE employee_id ='$reset_employeeId'";
						
                        if ($conn->query($sql)) {                       
                            $_SESSION["employee_id"] = $reset_employeeId;                           
                            $redirect_url = "Tsuccess.php?employee_id=" . urlencode($reset_employeeId);
